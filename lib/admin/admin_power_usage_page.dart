...
class _AdminPowerUsagePageState extends State<AdminPowerUsagePage> {
  ...
  Future<void> _fetchPendingPayments() async {
    try {
      final response = await http.get(Uri.parse("http://192.168.1.191/dacs3/get_pending_invoices.php"));
  ...
  Future<void> _fetchData() async {
    ...
    try {
      final response = await http.get(
          Uri.parse("http://192.168.1.191/dacs3/get_admin_usage.php?month=$filterMonth&year=$filterYear")
      );
      if (response.statusCode == 200) {
    ...
    if (confirm == true) {
      ...
      try {
        final res = await http.post(
          Uri.parse("http://192.168.1.191/dacs3/notify_high_usage.php"),
          body: {
              ...
              Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                ...
                Row(
                  children: [
                    ...
                    GestureDetector(
                        onTap: () async {
                          final res = await http.get(Uri.parse("http://192.168.1.191/dacs3/cron_monthly_save.php"));
